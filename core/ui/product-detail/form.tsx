...
const ProductDetailsForm = ({ submitHandler, finished, channel, shopInfo}) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="w-full">
      ...
      {!shopInfo && <code className='py-3'> this feature does't work at this page</code>}
    </form>
